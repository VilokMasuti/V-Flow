...
const RightSidebar = async () => {
  ...
  return (
    <section className="pt-36 custom-scrollbar   border-card border-l-neutral-50  border-dotted   shadow-xl sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l p-6   max-xl:hidden">
      <div>
