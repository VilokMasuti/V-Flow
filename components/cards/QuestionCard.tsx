...
const QuestionCard = ({ question: { _id, title, tags, author, createdAt, upvotes, answers, views } ,showActionBtns=false}: Props) => {
  return (
    <div className=" card-wrapper-hover card border border-[#1c1c1c] hover:border-[#2a2a2a] transition-colors duration-150  shadow-2xl bg-dark-100 r p-9 sm:px-11  rounded-2xl ">
