...
export const CreepyButton = ({
    ...
    return (
        <button
            className={cn(
                "relative min-w-[5em] rounded-xl bg-black cursor-pointer outline-none select-none group tap-highlight-transparent",
        ...
        >
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-xl bg-black text-white font-bold tracking-wider",
